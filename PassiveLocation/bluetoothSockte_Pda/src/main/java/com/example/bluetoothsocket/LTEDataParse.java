...
public class LTEDataParse {
    ...
    public synchronized void parseData(byte[] bytesReceived, int receiveCount) {
        ...
        byte[] a = new byte[receiveCount];
        System.arraycopy(bytesReceived, 0, a, 0, receiveCount);
        LogUtils.log(receiveCount+":"+bytesToHexString(a));
        ...
        while (true) {
            ...
            int contentLen = FormatUtils.byteToInt(contentLength) + 82;
    ...
    private void parsePackageData(byte[] tempPackage) {
        ...
        reverse(tempId);
        int id = FormatUtils.byteToInt(tempId);
        ltePackage.setId(id);
        ...
        int dataLength = FormatUtils.byteToInt(tempDataLength);
        ...
        reverse(tempType);
        ltePackage.setType(FormatUtils.byteToShort(tempType));
